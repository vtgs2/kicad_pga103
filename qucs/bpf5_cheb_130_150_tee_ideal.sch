...
<Properties>
  <View=0,0,1338,800,1,0,0>
  <Grid=10,10,1>
  <DataSet=bpf5_cheb_130_150_tee_ideal.dat>
  <DataDisplay=bpf5_cheb_130_150_tee_ideal.dpl>
  <OpenDisplay=1>
  <Script=bpf5_cheb_130_150_tee_ideal.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <L L1 1 200 180 8 -26 0 1 "7.117nH" 1 "" 0>
  <C C1 1 170 180 -8 46 0 1 "182.5pF" 1 "" 0 "neutral" 0>
  <GND * 1 200 210 0 0 0 0>
  <L L2 1 310 100 -26 -44 0 0 "545.6nH" 1 "" 0>
  <C C2 1 250 100 -26 10 0 0 "2.381pF" 1 "" 0 "neutral" 0>
  <L L3 1 340 180 8 -26 0 1 "4.133nH" 1 "" 0>
  <C C3 1 310 180 -8 46 0 1 "314.3pF" 1 "" 0 "neutral" 0>
  <GND * 1 340 210 0 0 0 0>
  <L L4 1 450 100 -26 -44 0 0 "545.6nH" 1 "" 0>
  <C C4 1 390 100 -26 10 0 0 "2.381pF" 1 "" 0 "neutral" 0>
  <L L5 1 480 180 8 -26 0 1 "7.117nH" 1 "" 0>
  <C C5 1 450 180 -8 46 0 1 "182.5pF" 1 "" 0 "neutral" 0>
...
<Diagrams>
  <Rect 760 580 531 500 3 #c0c0c0 1 00 1 0 0.2 1 1 -0.1 0.5 1.1 1 -0.1 0.5 1.1 315 0 225 0 0 0 "" "" "">
